    ...
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
      <div className="bg-card border border-border rounded-lg p-4 lg:p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-2">
          <h2 className="text-lg lg:text-xl font-semibold text-foreground">Editar Ingreso</h2>
          <button
            onClick={onClose}
        ...
        <p className="text-muted-foreground mb-4 text-sm lg:text-base">Modifica los datos del ingreso</p>
