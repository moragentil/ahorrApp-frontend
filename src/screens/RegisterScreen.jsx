    ...
    <div className="min-h-screen bg-gradient-to-r from-blue-900 to-blue-600 flex items-center justify-center px-2">
      <div className="max-w-md w-full bg-white rounded-lg shadow-md p-4 sm:p-8">
        <div className="text-center mb-4">
          ...
          <p className="text-gray-600 text-sm sm:text-base">Crea tu cuenta</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="name" className="block text-start text-sm sm:text-base font-medium text-gray-700">
              Nombre
            </label>
            <input
              type="text"
